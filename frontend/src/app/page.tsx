...
import { Sparkles, Image, Video, Gamepad2, Brain, Wand2, Share2 } from 'lucide-react'

export default function Home() {
  return (
    <main className="min-h-screen bg-black">
      {/* Hero Section */}
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 py-24 overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-5xl text-center space-y-8">
          ...
          {/* Subheading */}
          <p className="text-2xl md:text-3xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Transformez vos rêves en réalité visuelle
          </p>

          {/* Description */}
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
            Décrivez votre rêve et notre IA le transforme en image captivante,
            vidéo immersive ou expérience de jeu interactive.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link href="/dreamquest">
              <Button size="lg" className="bg-white text-blue-900 hover:bg-blue-50 text-lg px-8 py-6 h-auto shadow-xl shadow-blue-500/50">
                <Wand2 className="mr-2 h-5 w-5" />
                Commencer à Rêver
              </Button>
            </Link>
            <Link href="/dreamquest/gallery">
              <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 text-lg px-8 py-6 h-auto backdrop-blur-sm">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">1. Décrivez</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">2. Choisissez</h3>
              <p className="text-white/80 text-lg leading-relaxed">
                Sélectionnez le format de sortie : image, vidéo ou jeu 3D.
                Personnalisez le style et l'ambiance.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">3. Découvrez</h3>
              <p className="text-white/80 text-lg leading-relaxed">
      ...
      <section className="relative py-24 px-6 bg-black">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Image */}
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-600 p-8 hover:scale-105 transition-all">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <p className="text-white/90 text-lg">
                  ...
                  l'essence visuelle de votre rêve.
                </p>
              </div>
            </div>

            {/* Video */}
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-600 to-teal-600 p-8 hover:scale-105 transition-all">
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-all" />
              <div className="relative z-10 space-y-4">
                <Video className="w-12 h-12 text-white" />
                <h3 className="text-2xl font-bold text-white">Vidéos</h3>
                <p className="text-white/90 text-lg">
                  Des séquences animées immersives qui donnent vie à
                  votre rêve en mouvement.
                </p>
              </div>
            </div>

            {/* Game */}
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-600 to-emerald-600 p-8 hover:scale-105 transition-all">
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-all" />
              <div className="relative z-10 space-y-4">
                <Gamepad2 className="w-12 h-12 text-white" />
                <h3 className="text-2xl font-bold text-white">Jeux 3D</h3>
                <p className="text-white/90 text-lg">
                  Des mondes interactifs jouables où vous pouvez
                  explorer votre rêve en temps réel.
                </p>
              </div>
            </div>
          </div>
